			...
			<div class="card-body">
				<div class="card-text">
					<p>
						...
						<hr>
						<blockquote>
							Web Aplikasi untuk pelayanan surat administrasi desa yang dikembangkan oleh <b><a href="#" style="text-decoration:none">Alea Media Center</a></b> untuk mempermudah penduduk dalam pembuatan surat administrasi desa secara online.
							<br>
							<br>
						</blockquote>
					</p>
				...
				<div class="row text-center">
					<div class="col-md-12">
						...
						<p class="text-muted">Trademark By <b><a href="#" style="text-decoration:none">Alea Media Center.</a></b></p>
					</div>
